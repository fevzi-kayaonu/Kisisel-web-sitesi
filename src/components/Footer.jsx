  ...
  return (
    <>
      <footer className=" flex js-center bg-white padding-bottom-3 padding-top-3">
        <div className="flex js-center alg-center gap-4 padding-top-3 padding-bottom-3 position-relative flex-container ">
          <div className="flex column  alg-end fs-800 fw-500 lh-4 padding-bottom-3 ">
            <p className="z-index-2">{footerData[lang][0]}</p>
